        ...
        <header>
            <div className="container">
                <div className="inner-content">
                    <div className="brand">
                        <Link to="/">Digital Downloadable</Link>
                    </div>

                    <div className="search-bar">
                        <input className="search-input"
                        onChange={(e)=> setQuery(e.target.value)}
                        placeholder="Search download products"
                        value={query}>
                        </input>
                ...
                <div className="category-container">
                    <ul>
                        <li><Link to="/category/pdfs">PDFs</Link></li>
                        <li><Link to="/category/books">Books</Link></li>
                        <li><Link to="/category/drivers">Drivers</Link></li>
                        <li><Link to="/category/softwares">Softwares</Link></li>
                    </ul>
                </div>
            </div>
        </header>
